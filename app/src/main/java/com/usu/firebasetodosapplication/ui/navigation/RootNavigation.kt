...
import com.usu.firebasetodosapplication.ui.viewmodels.RouteNavigationViewModal
...
fun RootNavigation() {
    ...
    val viewModel: RouteNavigationViewModal = viewModel()
    ...
    Scaffold(
        ...
        NavHost(
            ...
            navigation(route = Routes.todosNavigation.route, startDestination = Routes.todos.route) {
                ...
                composable(route = "edittodo?id={id}", arguments = listOf(navArgument("id") {defaultValue= "new"})) {
                    navBackStackEntry ->
